...
<cfset myFusebox.thisFuseaction = "ajaxLoadForm">
...
<cfset xfa.loadTeam = "ah.ajaxLoadDoDTeamInfo" />
<cfset xfa.loadVerInfo = "ah.ajaxLoadDoDVerInfo" />
<cfset xfa.loadDBAs = "ah.ajaxLoadDoDDBAInfo" />
<cfset xfa.qryDoDPerson = "ah.qryDoDPerson" />
<cftry>
<cfoutput><cfinclude template="../adhocReports/qryLoadForm.cfm"></cfoutput>
<cfcatch type="missingInclude"><cfif len(cfcatch.MissingFileName) gte 15 and right(cfcatch.MissingFileName,15) is "qryLoadForm.cfm">
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse qryLoadForm.cfm in circuit ah which does not exist (from fuseaction ah.ajaxLoadForm).">
<cfelse><cfrethrow></cfif></cfcatch></cftry>
